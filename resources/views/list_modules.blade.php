            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Listagem de Módulos do Sistema</h4>
                                        <p class="card-title-desc">Gestão de Módulos do Sistema</p>

                                        <div class="w-50">
                                            <form name="drmBusca" id="frmNovo" action="/module" method="post">
                                            @csrf
                                            </form>
                                            <form name="drmBusca" id="frmbusca" action="/modules" method="get">
                                            @csrf
                                ...
                                <div class="card">
                                 ...
                                 @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td contenteditable="true">{{$d->slug}}</td>
                                       <td contenteditable="true">Fabiano Gomes</td>
                                       
                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/modules/{{$d->id_module}}'"
                                                            class="btn btn-primary btn-rounded waves-effect waves-light">Editar</button></span>

                                          <span class="table-remove"><button type="button"
                                                                class="btn btn-danger btn-rounded waves-effect waves-light" onclick="javascript:del( {{$d->id_module}} )">Deletar</button></span>
...
<script>
   ...
   function  del( id ) {
      ...
      if (confirm("Deseja mesmo delatar o registro?") == true) {
         window.location = '/modules/delete/' + id ;
      }
