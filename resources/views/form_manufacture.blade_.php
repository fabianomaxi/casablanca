                  ...
                  <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <form action="/manufacturer" method="post" id="frmCadastro">
                           <input type="hidden" name="id" id="id" value="{{@$data->id_manufacturer}}">
                                @csrf
                              <div class="form-row">
                                 <div class="col">
                                 ...
                                 <label for="phone">Telefone</label>
                                    <input type="text" value="{{@$data->phone}}" class="form-control" placeholder="Telefone" name="phone">
                                 </div>
