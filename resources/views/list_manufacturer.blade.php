            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Listagem de Fabricantes</h4>
                                        <p class="card-title-desc">Gestão de Fabricantes</p>

                                        <div class="w-50">
                                            <form name="drmBusca" id="frmNovo" action="/manufacture" method="post">
                                            @csrf
                                            </form>
                                            <form name="drmBusca" id="frmbusca" action="/manufactures" method="get">
                                            @csrf
                                ...
                                <div class="card">
                                 ...
                                 @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/manufacturer/{{$d->id_manufacturer}}'"
                                             class="btn btn-primary btn-rounded waves-effect waves-light">Editar</button></span>

                                             <span class="table-remove"><button type="button"
                                                class="btn btn-danger btn-rounded waves-effect waves-light" onclick="javascript:del( {{$d->id_manufacturer}} )">Deletar</button></span>
                                       </td>
                                    </tr>
...
function  del( id ) {
   ...
   if (confirm("Deseja mesmo delatar o registro?") == true) {
      window.location = '/manufacturer/delete/' + id ;
   }
