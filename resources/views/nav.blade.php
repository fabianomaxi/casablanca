<nav class="navbar navbar-expand-lg navbar-light p-0">
   <div class="iq-search-bar">
      <form action="/products/search" class="searchbox" id="search" method="post">
         @csrf
         <input type="text" name="search" value="{{@request()->search}}" class="text search-input" placeholder="Digite para localizar um equipamento">
         <a class="search-link" href="#" onclick="$('#search').submit()"><i class="ri-search-line"></i></a>
      </form>
   </div>
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto navbar-list">
         <li class="nav-item" style="display:none">
            <a class="search-toggle iq-waves-effect language-title" href="#"><img src="{{URL::to('/')}}/images/small/flag-01.png" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> Portu <i class="ri-arrow-down-s-line"></i></a>
         ...
         <li class="nav-item">
            ...
            <div class="iq-sub-dropdown">
               <div class="iq-card shadow-none m-0">
                  <div class="iq-card-body p-0 " style="display:none">
         ...
         <li class="nav-item dropdown">
            ...
            <div class="iq-sub-dropdown">
               <div class="iq-card shadow-none m-0" style="display:none">
      ...
      <li>
         <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
            ...
            <div class="caption">
               ...
               <span class="font-size-12">125.254.547.22</span>
            </div>
         </a>
