                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Cadastro de Perfis</h5><br>
                                        <form action="/users" method="post" id="frmCadastro">
                              ...
                              <div class="form-row">
                                 ...
                                 <label for="email">E-mail</label>
                                    <input type="email"  value="{{@$data->email}}" class="form-control" required placeholder="Email" name="email">
                                 </div>
                                 
                                 <div class="col">
                                 <label for="email">Senha</label>
                                    <input type="password" value="{{@$data->password}}" class="form-control" required placeholder="Senha" name="password">
                                 </div>
                             ...
                             <label for="email">Perfil</label>
                                <select class="form-control" id="exampleFormControlSelect1" required name="id_profile">
                                    ...
                                    @foreach( $profiles as $profile )
                                       <option value="{{$profile->id_profile}}" {{(@$data->id_profile == $profile->id_profile) ? 'selected' : ''}}>{{$profile->name}}</option>
                                    @endforeach
                                 </select>
                             </div>
                            </div>
