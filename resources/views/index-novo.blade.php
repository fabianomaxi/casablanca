                                    ...
                                    <div class="card-body pt-2">
                                        <div class="table-responsive" data-simplebar style="max-height: 358px;">
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 20px;"><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-4.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-5.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-6.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-7.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-8.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-2.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                            <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-1.jpg" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                                            <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                            <p class="text-muted mb-0 font-size-14">sonyahenshaw@tocly.com</p>
                                                        </td>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-2.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Neal Matthews</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-3.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jamal Burnett</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-4.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Juan Mitchell</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-5.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-6.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Ronald Taylor</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{URL::to('/')}}/assets-novo/images/users/avatar-7.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jacob Hunter</td>
...
<!-- Mirrored from themesdesign.in/tocly/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2023 00:03:40 GMT -->
</html>