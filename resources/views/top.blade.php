...
<div class="iq-navbar-custom">
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-0">
        <div class="iq-search-bar">
            <form action="/products/search" method="post" id="search_prod" class="searchbox">
                @csrf
                <input name="search" id="search" type="text" class="text search-input" placeholder="Pesquisar por Nome, Série ou Etiqueta">
                <a class="search-link" onclick="javascript:$('#search_prod').submit()" href="#"><i class="ri-search-line"></i></a>
            </form>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                <a class="search-toggle iq-waves-effect language-title" href="#"><img style="display: none;" src="{{URL::to('/')}}/images/small/flag-01.png" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> Português <i class="ri-arrow-down-s-line"></i></a>
                    ...
                    <div class="iq-card shadow-none m-0">
                        ...
                        <a href="#" class="iq-sub-card" >
                            <div class="media align-items-center" style="display:none">
                                <div class="">
                                    <img class="avatar-40 rounded" src="{{URL::to('/')}}/images/user/06.jpg" alt="">
                                </div>
                    ...
                    <div class="iq-card shadow-none m-0">
                        ...
                        <a href="#" class="iq-sub-card" >
                            <div class="media align-items-center" style="display:none">
                                ...
                                <div class="media-body ml-3">
                                    <h6 class="mb-0 ">{{ @Session::get('nameSession')}}</h6>
        ...
        <ul class="navbar-list">
            ...
            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                <img src="{{URL::to('/')}}/images/user/06.jpg" class="img-fluid rounded mr-3" alt="user">
                <div class="caption">
                    <h6 class="mb-0 line-height">{{ @Session::get('nameSession')}}</h6>
                    <span class="font-size-12">{{\Request::ip()}}</span>
                </div>
            </a>
            <div class="iq-sub-dropdown iq-user-dropdown" style="display:none;">
                <div class="iq-card shadow-none m-0">
                    <div class="iq-card-body p-0 ">
                        <div class="bg-primary p-3">
