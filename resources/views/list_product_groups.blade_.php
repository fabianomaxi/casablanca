                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Gestão de Grupos de Equipamentos</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <div id="table" class="table-editable">
                              ...
                              <button class="btn btn-sm iq-bg-success"><i
                                 class="ri-add-fill"><a href="/product_group"><span class="pl-1">Novo Cadastrto</span></a></i>
                              </button>
                              </span>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                             ...
                                             <span class="table-remove"><button type="button"
                                                class="btn iq-bg-danger btn-rounded btn-sm my-0" onclick="javascript:del( {{$d->id_product_group}} )">Deletar</button></span>
                                       </td>
                                    </tr>
