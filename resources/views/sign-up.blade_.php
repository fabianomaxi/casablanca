                ...
                <div class="row no-gutters">
                    <div class="col-md-6 text-center">
                        <div class="sign-in-detail text-white">
                            ...
                            <div  style="padding-top: 150px;" class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="0">
                                <div class="item">
                                    <img src="{{URL::to('/')}}/images/login/1.png" class="img-fluid mb-4" alt="logo">
                                    <h4 class="mb-1 text-white">Sistema de Gestão Online</h4>
                                    <p>Infore ao lado suas credenciais para ter acesso ao sistema.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control mb-0" id="senha" name="senha" required placeholder="Sua Senha">
                                </div>
                                <div class="d-inline-block w-100">
                                    <button type="submit" name="btn-acessar" id="btn-acessar" class="btn btn-primary float-right">Acessar</button>
                                </div>
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Não tem cadastro? <a href="/index">Cadastre-se</a></span>
