                                                    ...
                                                    <div class="p-lg-5 p-4">
                                                        <div>
                                                            <div class="text-center mt-1">
                                                                ...
                                                                <p class="text-muted">Informe os dados abaixo para seu cadastro.</p>
                                                            </div>
                                                            <form class="auth-input" method="post" id="frm_register" name="frm_registere" action="/register">
                                                                    @csrf
                                                                    <input type="hidden" name="by" value="signup">
                                                                    <input type="hidden" name="id_profile" value="48">
                                                                    <input type="hidden" name="id_module_departament" value="5">
                                                                    
                                                                    
                                                                    <div class="mb-2">
                                                                        <label for="username" class="form-label">Qual seu nome?</label>
                                                                        <input required="required" type="text" class="form-control" id="name" name="name" placeholder="Informe seu Nome">
                                                                    </div>

                                                                    <div class="mb-2">
                                                                        <label for="username" class="form-label">Qual seu telefone?</label>
                                                                        <input required="required" type="text" class="form-control" id="phone" name="phone" placeholder="Informe seu Telefone">
                                                                    </div>
                                                                ...
                                                                <div class="mt-4 text-center">
                                                                    <p class="mb-0"><a href="/login" class="fw-medium text-primary"> Voltar para Login </a> </p>
                                                                </div>
                                                                <div class="mt-3">
                                                                    <button class="btn btn-primary w-100" type="submit" >Cadastrar e Acessar</button>
                                                                </div>
                                                            </form>
                                                        </div>
