...
<html lang="pt_br">
                        ...
                        <div class="iq-card-body">
                           <div id="table" class="table-editable">
                              ...
                              <button class="btn btn-sm iq-bg-success"><i
                                 class="ri-add-fill"><a href="/maintenance"><span class="pl-1">Novo Cadastrto</span></a></i>
                              </button>
                              </span>
                                       ...
                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/maintenances/{{$d->id_maintenance}}'"
                                             ...
                                             <span class="table-remove"><button type="button"
                                                class="btn iq-bg-danger btn-rounded btn-sm my-0" onclick="javascript:del( {{$d->id_maintenance}} )">Deletar</button></span>
                                       </td>
                                    </tr>
   ...
   function  del( id ) {
      ...
      if (confirm("Deseja mesmo delatar o registro?") == true) {
         window.location = '/maintenances/delete/' + id ;
      }
