                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Gestão de Usuários</p>

                                        <div class="w-50">
                                            <form name="drmBusca" id="frmNovo" action="/user" method="post">
                                            @csrf
                                            </form>
                                            <form name="drmBusca" id="frmbusca" action="/users" method="get">
                                            @csrf
                                ...
                                <div class="card">
                                 ...
                                 @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td contenteditable="true">Almoxarifado</td>

                                       <td>
                                           <span class="table-remove"><button type="button" onclick="javascript:window.location='/users/{{$d->id_user}}'"
                                                            class="btn btn-primary btn-rounded waves-effect waves-light">Editar</button></span>

                                             <span class="table-remove"><button type="button"
                                                                class="btn btn-danger btn-rounded waves-effect waves-light" onclick="javascript:del( {{$d->id_user}} )">Deletar</button></span>
