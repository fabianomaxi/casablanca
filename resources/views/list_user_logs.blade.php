...
<html lang="pt_br">
                        ...
                        <div class="iq-card-body">
                           <div id="table" class="table-editable">
                              ...
                              <button class="btn btn-sm iq-bg-success"><i
                                 class="ri-add-fill"><a href="/user_log"><span class="pl-1">Novo Cadastrto</span></a></i>
                              </button>
                              </span>
                              <table class="table table-bordered table-responsive-md table-striped text-center">
                                 ...
                                 @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td contenteditable="true">{{$d->action}}</td>
                                       <td contenteditable="true">{{$d->data_json}}</td>
                                       <td contenteditable="true">{{$d->id_user}}</td>
                                       <td contenteditable="true">{{$d->id_module}}</td>

                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/user_logs/{{$d->id_user_log}}'"
                                             class="btn iq-bg-primary btn-rounded btn-sm my-0">Editar</button></span>

                                             <span class="table-remove"><button type="button"
                                                class="btn iq-bg-danger btn-rounded btn-sm my-0" onclick="javascript:del( {{$d->id_user_log}} )">Deletar</button></span>
   ...
   function  del( id ) {
      ...
      if (confirm("Deseja mesmo delatar o registro?") == true) {
         window.location = '/user_logs/delete/' + id ;
      }
