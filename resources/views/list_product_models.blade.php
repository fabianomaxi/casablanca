                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="w-50">
                                            <form name="drmBusca" id="frmNovo" action="/product_model" method="post">
                                            @csrf
                                            </form>
                                            <form name="drmBusca" id="frmbusca" action="/product_models" method="get">
                                            @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                 ...
                                 <thead>
                                    <tr>
                                       <th>Nome do Modelo de Equipamentos</th>
                                       <th>Descrição</th>
                                       <th>Usuário</th>
                                       <th>Ações</th>
                                    </tr>
                                 ...
                                 @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/product_models/{{$d->id_product_models}}'"
                                             class="btn btn-primary btn-rounded waves-effect waves-light">Editar</button></span>

                                             <span class="table-remove"><button type="button"
                                                class="btn btn-danger btn-rounded waves-effect waves-light" onclick="javascript:del( {{$d->id_product_models}} )">Deletar</button></span>
                                       </td>
                                    </tr>
...
if (confirm("Deseja mesmo delatar o registro?") == true) {
   window.location = '/product_models/delete/' + id ;
}
