                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Gestão de Locais de Estoque</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           
                           <form action="/stock_locations" method="post" id="frmCadastro">
                           <input type="hidden" name="id" id="id" value="{{@$data->id_stock_locations}}">
                                @csrf
                              <div class="form-row">
                                 <div class="col">
                                 ...
                                 <div class="col">
                                 <label for="email">Placa do veículo</label>
                                    <input type="text" value="{{@$data->license_plate}}" class="form-control"  placeholder="Placa do veículo" name="license_plate">
                                 </div>
                                 
                                 <div class="col">
                                 <label for="email">Logradouro</label>
                                    <input type="text" value="{{@$data->logradouro}}" class="form-control"  placeholder="Logradouro" name="logradouro">
                                 </div>
                            ...
                            <div class="form-row">
                             ...
                             <label for="email">Status</label>
                                <select class="form-control" id="exampleFormControlSelect1" required name="status">
                                    <option value=""  {{(@$data->status == 0) ? 'selected' : ''}}>Status</option>
                             ...
                             <div class="col">
                             <label for="email">Tipo de Estoque</label>
                                 <select class="form-control" id="exampleFormControlSelect1" required name="tipo">
                                    <option value="" >Tipo de Estoque</option>
                                    <option value="1" {{(@$data->tipo == 1) ? 'selected' : ''}}>Padrão</option>
                                    <option value="2" {{(@$data->tipo == 2) ? 'selected' : ''}}>Móvel</option>
                                    <option value="3" {{(@$data->tipo == 3) ? 'selected' : ''}}>Externo</option> 
                                 </select>
                             </div>
