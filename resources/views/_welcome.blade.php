                        ...
                        <div class="sign-in-detail text-white">
                            <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="0">
                                <div class="item">
                                    ...
                                    <h4 class="mb-1 text-white">Sistema Unificado Casa Blanca Online</h4>
                    ...
                    <div class="col-md-6 position-relative">
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4" method="post" id="frm_login" name="frm_login" action="/valida-login">
                                ...
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Esqueceu sua senha? <a onclick="botaoNovaSenha({{$d->id_user}})">Solicite aqui</a></span>
