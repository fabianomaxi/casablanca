   ...
   <!-- Sidebar -->
    <div class="sidebar">
      ...
      <ul class="nav navbar-nav">   
         ...
         <li><a class="nav-link" href="consulta_equipamentos">
            ...
            <span>Consultar Equip.</span>
         </a></li>

         <li><a class="nav-link" href="ocorrencias">
         ...
         <li><a class="nav-link" href="solic_permissoes">
         ...
         <li><a class="nav-link" href="mov_lote">
            <span class="dz-icon bg-red light">
            <svg height="18" viewBox="0 -8 464 464" width="18" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="m360 144h-120v-40c0-4.417969-3.582031-8-8-8s-8 3.582031-8 8v40h-120c-4.417969 0-8 3.582031-8 8v48c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-40h240v40c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-48c0-4.417969-3.582031-8-8-8zm0 0" fill="#f7cc38"></path><path d="m424 320h-56v-40c0-4.417969-3.582031-8-8-8s-8 3.582031-8 8v40h-56c-4.417969 0-8 3.582031-8 8v48c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-40h112v40c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-48c0-4.417969-3.582031-8-8-8zm0 0" fill="#f7cc38"></path><path d="m168 320h-56v-40c0-4.417969-3.582031-8-8-8s-8 3.582031-8 8v40h-56c-4.417969 0-8 3.582031-8 8v48c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-40h112v40c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-48c0-4.417969-3.582031-8-8-8zm0 0" fill="#f7cc38"></path><path d="m56 192h96v96h-96zm0 0" fill="#60a2d7"></path><path d="m176 0h112v112h-112zm0 0" fill="#5f7bad"></path><path d="m408 288h-96v-96h96zm0 0" fill="#60a2d7"></path><g fill="#92aeba"><path d="m0 368h80v80h-80zm0 0"></path><path d="m128 368h80v80h-80zm0 0"></path><path d="m256 368h80v80h-80zm0 0"></path><path d="m384 368h80v80h-80zm0 0"></path></g>
                                                </svg>
            </span>
            <span>Movimentações Lote</span>
         </a></li>
        ...
        <div class="content-inner pt-0">
         <div class="container fb">
               ...
               <div class="m-b10" style="display: none;">
                    ...
                    <div class="col">
                        <div class="title-bar">
                            <h5 class="dz-title">Consultar Equipamentos</h5>
                        </div>
                        <label for="email">Escaneie o código de barras ou digite o número da etiqueta abaixo:</label>
                    </div>
...
<div class="modal fade" id="etiqueta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form action="/save-occurrence-app" method="post" id="frmSaida" name="frmSaida">   
  @csrf
   ...
   <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Consulta de Equipamento</h5>

      </div>
      <div class="modal-body">
        
        <div class="title-bar">
            <h5 class="dz-title">Dados do equipamento</h5>
        </div>
        <div class="form-group">
            <label for="recipient-name" class="col-form-label" >
                <span style="font-weight: bold;">Produto:</span> <span id="produto"></span>
            </label>
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Digite a Etiqueta:</label>
            <input type="text" required onblur="javascript:buscaProd()" class="form-control" id="numero-etiqueta" name="label_number">
          </div>
          
          <div class="form-group">
            <label for="message-text" class="col-form-label">Observações da ocorrência:</label>
            <textarea class="form-control" required name="obs" id="message-text"></textarea>
          </div>
        
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="javascript:$('#etiqueta').modal('hide')" data-dismiss="modal">Fechar</button>
        <button type="submit" disabled="disabled" id="btmCadastra" class="btn btn-primary">Abrir Ocorrêcia</button>
      </div>
    </div>
  </div>
  </form>
