        ...
        <div class="content-inner pt-0">
         <div class="container fb">
               ...
               <div class="m-b10" style="display: none;">
                ...
                <form class="m-b30" method="post" action="/busca-prod-app" id="frmEquipe" name="frmEquipe">
                    <div class="title-bar">
                        <h5 class="dz-title">Permissões de Acesso</h5>
                    </div>

                    <div class="col">
                        <label for="email">Acesso ao Módulo:</label>
                        <select class="form-control" id="id_stock_locations" required name="id_stock_locations">
                            <option value="">selecione</option>
                                <option value="">Consulta Equipamentos</option>
                                <option value="">Movimentações</option>
                                <option value="">Movimentações em Lote</option>
                                        
                        </select>
                    </div>

                    <div class="col" style="padding: 10px 0;">
                        <label for="email">Motivo da solicitação</label>
                        <input type="text" class="form-control" id="id_stock_locations" required name="id_stock_locations">
                    </div>


                    <div style="padding-top: 10px;">
                        <input type="submit" id="btn" class="btn light btn-info w-100" value="Solicitar Permissão">
                    </div>
                </form>
                    <div class="title-bar" style="padding-top: 20px;">
                        <h5 class="dz-title">Permissões Solicitadas</h5>
                    </div>
                                ...
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        <div class="item-title-row">
                                            ...
                                            {{date('d/m/Y H:i:s',strtotime($permission->date))}} - {{$permission->status}}
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="item-price">Módulo: {{$permission->id_modules}}</div>
                                        </div>
                                        <hr />
                                        ...
                                        <svg class="text-primary" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            ...
                                            <div class="item-price">{{$permission->obs}}</div>
                                        </div>
                                    </div>
                                </div>
