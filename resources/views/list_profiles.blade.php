            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Listagem de Perfis do Sistema</h4>
                                        <p class="card-title-desc">Gestão de Perfis do Sistema</p>

                                        <div class="w-50">
                                            <form name="drmBusca" id="frmNovo" action="/profile" method="post">
                                            @csrf
                                            </form>
                                            <form name="drmBusca" id="frmbusca" action="/profiles" method="get">
                                            @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <tr>
                                       ...
                                       <th>Descrição</th>
                                       <th>Usuário</th>
                                       <th style="width: 30%; text-align: center;" colspan="3">Ações</th>
                                    </tr>
                                 </thead>
                                                <tbody>
                                                @foreach( $data as $d )
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                                <span class="table-remove"><button onclick="javascript:getModules( '{{@$d->id_profile}}' )" type="button"
                                                    class="btn btn-warning btn-rounded waves-effect waves-light">Módulos Associados</button></span>

                                        </td>
                                        <td>
                                                <span class="table-remove"><button type="button"
                                                    class="btn btn-danger btn-rounded waves-effect waves-light" onclick="javascript:del( {{$d->id_profile}} )">Deletar</button></span>
