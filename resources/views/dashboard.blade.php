                                ...
                                <div class="card">
                                    <div class="card-header border-0 align-items-center d-flex pb-0">
                                        <h4 class="card-title mb-0 flex-grow-1">
                                            Últimas Movimentações</h4>
                                        <div>
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-reset" href="#" data-bs-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    <span class="fw-semibold">Ordenar por:</span>
                                                    <span class="text-muted">Equipamento<i class="mdi mdi-chevron-down ms-1"></i></span>
                                                </a>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript: void(0);" class="text-body">2540</a> </td>
                                                        <td><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHIjL7qKYHCxg5hSurDZH-eF1SllN8tUyV8JJrOZn5SXQpNZshWI7W-0l_zzwFDmnQCtg&usqp=CAU" class="avatar-xs rounded-circle me-2" alt="..."> 
                                                            2 Die Sets p/ conectore HBCP-D33UHD
                                                        </td>
                                                        <td><p class="mb-0">Almox.BV</p></td>
                                                        <td>
                                                        Almoxarifado VM
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript: void(0);" class="text-body">30/06/2023</a> </td>
                                                        <td><a href="javascript: void(0);" class="text-body">2540</a> </td>
                                                        <td><img src="https://d58a5eovtl12n.cloudfront.net/Custom/Content/Products/47/85/47856_ultradriver-behringer-dcx2496_m1_638049705019998772.png" class="avatar-xs rounded-circle me-2" alt="..."> 
                                                        Amplificador de áudio UltraDrive PRO
                                                        </td>
                                                        <td><p class="mb-0">Almox.BV</p></td>
                                                        <td>
                                                            FAbiano Gomes
