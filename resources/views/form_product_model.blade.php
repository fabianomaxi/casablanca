                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Cadastro de Modelos de Equipamentos</h5><br>
                                        <form  action="/product_models" method="post" id="frmCadastro">
                           <input type="hidden" name="id" id="id" value="{{@$data->id_product_models}}">
                                @csrf
                             <div class="form-row">
                                 <div class="col">
