                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Gestão de Modelo de Equipamentos</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <div id="table" class="table-editable">
                              ...
                              <button class="btn btn-sm iq-bg-success"><i
                                 class="ri-add-fill"><a href="/product_model"><span class="pl-1">Novo Cadastrto</span></a></i>
                              </button>
                              </span>
                                       ...
                                       <td>
                                          <span class="table-remove"><button type="button" onclick="javascript:window.location='/product_models/{{$d->id_product_models}}'"
                                             ...
                                             <span class="table-remove"><button type="button"
                                                class="btn iq-bg-danger btn-rounded btn-sm my-0" onclick="javascript:del( {{$d->id_product_models}} )">Deletar</button></span>
                                       </td>
                                    </tr>
