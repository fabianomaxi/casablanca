var options = {
    series: [
        { name: "Net Profit", data: [19, 36, 24, 20, 34, 24, 11, 36, 24, 15, 21, 28] },
        { name: "Revenue", data: [7, 12, 10, 12, 11, 10, 13, 10, 12, 8, 13, 13] },
    ],
    chart: { type: "bar", height: 350, stacked: !0, toolbar: { show: !1 }, zoom: { enabled: !0 } },
    plotOptions: { bar: { horizontal: !1, columnWidth: "42%" } },
    dataLabels: { enabled: !1 },
    legend: { show: !1 },
    xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sep", "Oct", "Nov", "Des"] },
...
var worldlinemap = new jsVectorMap({
    ...
    zoomOnScroll: !1,
    zoomButtons: !1,
    markerStyle: { initial: { fill: "#0c768a" }, selected: { fill: "#0c768a" } },
    markers: [
    ...
    regionStyle: { initial: { stroke: "#daeaee", strokeWidth: 0.25, fill: "#daeaee", fillOpacity: 1 } },
    lineStyle: { animation: !0, strokeDasharray: "6 3 6" },
}),
options = {
    labels: ["E-Commerce", "Facebook", "Instagram"],
    series: [38, 24, 16],
    chart: { height: 402, type: "donut" },
    plotOptions: { pie: { startAngle: -90, endAngle: 90, offsetY: 10, donut: { size: "80%" } } },
    colors: ["#0c768a", "#38c786", "#daeaee"],
    grid: { padding: { bottom: -190 } },
    legend: { show: !1 },
    responsive: [{ breakpoint: 320, options: { chart: { width: 180 }, legend: { position: "bottom" } } }],
};